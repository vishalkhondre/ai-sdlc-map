...
Never manufacture editorial acceptance. Content changes need an edition/changelog
update and an ACCEPT report bound to the final sources. Tooling-only fixes do not bump
the prose edition. Keep PR preparation separate from human approval and deployment.
