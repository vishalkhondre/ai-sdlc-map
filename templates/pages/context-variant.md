...
<!-- Template for a Context variant page (project/APPROACH.md). Copy to content/pages/<band>/<id>.md,
...
<!-- The kind of project, product or change flow, and how to recognise it. -->

## What changes

<!-- How delivery differs from the full-feature default. -->

## Gates that move

<!-- Which gates are added, removed, deepened or moved, and why. -->

## Risk tier

<!-- The usual risk tier and what raises or lowers it. -->

## Workflows affected

<!-- The workflows that behave differently here. -->

## Related

<!-- Links to related variants, phases and workflows. -->
